...
for name, value in top20_items:
    ratings20.append(value)

print(movie20)
print(ratings20)

val = ratings20    # the bar lengths
pos = arange(20)+.5   # the bar centers on the y axis

#plt.figure(1)
principal = plt.barh(pos,val, align='center')
plt.yticks(pos, (movie20))
plt.xlabel('ratings')
plt.title('top 20')
plt.show()
...
# plt.plot(frames(0), frames(1), color='green', marker='o', linestyle='solid')
